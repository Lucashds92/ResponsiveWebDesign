In this Responsive Web Design Certification, I learned the languages that are used to build webpages: HTML (Hypertext Markup Language) for content, and CSS (Cascading Style Sheets) for design.
